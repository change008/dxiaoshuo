...
<script type="text/javascript" src="<%=path %>/static/js/public.js"></script>
	<script>
    	...
    	document.write(unescape("%3Cspan id='cnzz_stat_icon_1262618547'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "w.cnzz.com/q_stat.php%3Fid%3D1262618547' type='text/javascript'%3E%3C/script%3E"));
    </script>
</html>